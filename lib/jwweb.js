...
JwwebUser.URL_LOGIN      = ROOT_URL + '_data/index_LOGIN.aspx';
JwwebUser.URL_VIEW_SCORE = ROOT_URL + 'xscj/c_ydcjrdjl.aspx';
JwwebUser.URL_POST_SCORE = ROOT_URL + 'xscj/c_ydcjrdjl_rpt.aspx';
JwwebUser.URL_CAPTCHA    = ROOT_URL + 'sys/ValidateCode.aspx';
JwwebUser.URL_LOGOUT     = ROOT_URL + 'sys/Logout.aspx';
JwwebUser.URL_FOOTER     = ROOT_URL + 'PUB/foot.aspx';
