...
const ROOT_URL = 'http://218.65.5.214:2001/jwweb/';
const URL_LOGIN      = ROOT_URL + '_data/index_LOGIN.aspx';
const URL_VIEW_SCORE = ROOT_URL + 'xscj/c_ydcjrdjl.aspx';
const URL_POST_SCORE = ROOT_URL + 'xscj/c_ydcjrdjl_rpt.aspx';
const URL_CAPTCHA    = ROOT_URL + 'sys/ValidateCode.aspx';
const URL_LOGOUT     = ROOT_URL + 'sys/Logout.aspx';
const URL_FOOTER     = ROOT_URL + 'PUB/foot.aspx';
