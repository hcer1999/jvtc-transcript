...
function sendRequest(url, userOptions) {
    ...
    return new Promise(function(resolve, reject) {
        let options = Object.assign({timeout: 6000, url}, userOptions);
        let response;
...
exports.connect = function(cb) {
    ...
    sendRequest(LOGIN_PAGE_URL).then(function({response, body}) {
...
exports.isLogin = function(uid, cb) {
    ...
    sendRequest(VIEW_SCORE_PAGE_URL, { 
        headers: {
            Cookie: record.sessionCookie
        }
    }).then(function({response, body}) {
